...
console.log(color('info', '▶️  Starting coding exercise setup...'))
...
var command =
    'npx "https://gist.github.com/denjalonso/043c368e6eacba024860d3191492ec41" -q'
console.log(
...
if (result.status === 0) {
    console.log(color('success', '✅  Exercise setup complete...'))
} else {
